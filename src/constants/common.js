...
export const GoogleOAuth = {
  clientId:
    "496652059877-4c2b965bb7i74rqfbu4khs0s5hklk9i9.apps.googleusercontent.com",
...
export const BuildDateTime =
  process.env.NODE_ENV === "production"
    ? new Date(parseInt(process.env.REACT_APP_BUILD_DATE))
    : new Date();
