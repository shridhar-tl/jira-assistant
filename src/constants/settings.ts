...
export type SettingsCategoryType = (typeof SettingsCategory)[keyof typeof SettingsCategory];

export const defaultSettings = {
    openTicketsJQL: 'assignee=currentUser() AND resolution=Unresolved and status != Closed',
    jiraUpdatesJQL:
        '(comment ~ currentUser() or summary ~ currentUser() or description ~ currentUser() or assignee = currentUser() ' +
...
export const momentizedDateFormats: Record<string, string> = {
