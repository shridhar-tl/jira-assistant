    ...
    renderFooter() {
        ...
        return <div className="pnl-footer">
            {reportQuery.id && <div className="float-start">
                ...
                <Button icon="fa fa-save" label="Save Query As" type="primary" onClick={this.showSaveDialog} disabled={!isSaveEnabled} />
            </div>}

            <div className="float-end">
                <Button icon="fa fa-save" label="Save Query" type="primary" onClick={isEditing ? this.saveAs : this.showSaveDialog}
