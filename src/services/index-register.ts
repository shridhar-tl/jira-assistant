...
import { AnalyticsServiceFake, injectable } from './index-common';
...
export default function registerServices(): void {
    if (_commonInjected) {
        return;
    }
    ...
    injectable(MessageService, 'MessageService', '$message', { isSingleton: true, retain: true });
