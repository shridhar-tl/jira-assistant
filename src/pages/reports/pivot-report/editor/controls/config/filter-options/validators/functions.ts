...
interface AllowedFunction {
    name: string;
    parameters: FunctionParam[];
    returns: string | string[];
}

const allowedFunctions: AllowedFunction[] = [
    {
...
export const allowedFunctionsMap = allowedFunctions.reduce((obj: Record<string, AllowedFunction>, func) => {
