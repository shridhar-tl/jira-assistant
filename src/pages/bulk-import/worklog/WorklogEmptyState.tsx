...
function WorklogEmptyState({ onDownloadTemplate, onUploadClick }: WorklogEmptyStateProps) {
    return (
        <div className="empty-state-layout">
            ...
            <div className="upload-panel">
                ...
                <h2 className="upload-panel-title">No Data Loaded</h2>
                <p className="upload-panel-desc">
                    Upload a CSV file containing your worklog entries. Download the template to see the expected column format.
                </p>
            ...
            {/* Right panel — how to use (original details/summary style) */}
                    ...
                    <div className="px-5 py-4 bg-blue-50/50 dark:bg-blue-950/20 border-t border-blue-200 dark:border-blue-800">
                        <ul className="space-y-2 text-sm text-secondary">
                            <li className="flex gap-2">
                                ...
                                <span>
                                    Click <strong>Download Template</strong> to get a sample CSV file showing the expected format — columns
                                    are <strong>Ticket No</strong>, <strong>Start Date</strong>, <strong>Timespent</strong>, and{' '}
...
export default WorklogEmptyState;
